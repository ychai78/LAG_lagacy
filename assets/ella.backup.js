...
(function($) {
    ...
    // Product page descripton - shorten if it is too long.  
    $('#tab-description .panel-body').readmore({
      speed: 700,
      collapsedHeight:150,
      moreLink: '<a href="#"  class="read-more-less read-more">Read more</a>',
      lessLink: '<a href="#" class="read-more-less read-less">Read less</a>'
    });
